...
_LABEL_1AA6_22:
	...
	;at $D300 is treated as an index into an array
	;of tile data stored at $0100
	ld   ($D34C), a		
...
;*  index into a tile array starting at $0100.
;*************************************************************
WriteIndexedTileToVRAM:
	ld   hl, $D300
	ld   b, $20
-:	ld   e, (hl)
	ld   d, $01
